...
```
указывает, что нужно выполнять поиск выражений вида  
...
126   )
```  
то АР добавит комментарий к строке 126  
```python
123   ... = reverse(
124       'new:edit', 
125       kwargs={'id': post_id}
...
    `'one'`|`'all'`|`'as-note'`  
    Умолчание: `'as-note'`  
Настройка повторных комментированиий в пределах одного файла-исходника.  
